              ...
              ? column.links.map((link) => {
                  ...
                  return (
                    <li key={link.label} className="mb-2">
                      ...
                      >
                        {link.label === 'Facebook' && (
                          <span className="w-[38px] h-[38px] flex items-center justify-center rounded-full mr-1.5 transition-all duration-200 bg-[#3b5998] text-white">
                            <svg
                        ...
                        {link.label === 'Instagram' && (
                          <span className="w-[38px] h-[38px] flex items-center justify-center rounded-full mr-1.5 transition-all duration-200 bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white">
                            <svg
                              className="w-5 h-5 fill-current"
                              viewBox="0 0 24 24"
                              xmlns="http://www.w3.org/2000/svg"
                        ...
                        {link.label === 'WhatsApp' && (
                          <span className="w-[38px] h-[38px] flex items-center justify-center rounded-full mr-1.5 transition-all duration-200 bg-[#25d366] text-white">
                            <svg
                              className="w-5 h-5 fill-current"
                              viewBox="0 0 24 24"
                              xmlns="http://www.w3.org/2000/svg"
                        ...
                        {link.label === 'LinkedIn' && (
                          <span className="w-[38px] h-[38px] flex items-center justify-center rounded-full mr-1.5 transition-all duration-200 bg-[#0077b5] text-white">
                            <svg
                              className="w-5 h-5 fill-current"
                              viewBox="0 0 24 24"
                              xmlns="http://www.w3.org/2000/svg"
