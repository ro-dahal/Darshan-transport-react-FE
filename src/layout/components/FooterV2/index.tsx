...
import { FOOTER_COLUMNS_V2 } from './footerLinksV2';
...
export const FooterV2: React.FC = () => {
  const companyCol = FOOTER_COLUMNS_V2[0];
  const servicesCol = FOOTER_COLUMNS_V2[1];
  const connectCol = FOOTER_COLUMNS_V2[2];
