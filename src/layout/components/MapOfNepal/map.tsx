      ...
      >
        <g id="features">
          <path
            ...
            name="Karnali"
            fill={
              hoveredPath === 'NPKA' ? 'var(--primary-light)' : 'var(--primary)'
            }
            strokeWidth={1}
          ...
          <path
            ...
            name="Mahakali"
            fill={
              hoveredPath === 'NPMA' ? 'var(--primary-light)' : 'var(--primary)'
            }
            strokeWidth={1}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          ...
          <path
            ...
            name="Seti"
            fill={
              hoveredPath === 'NPSE' ? 'var(--primary-light)' : 'var(--primary)'
            }
            strokeWidth={1}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          ...
          <path
            ...
            name="Dhawalagiri"
            fill={
              hoveredPath === 'NPDH' ? 'var(--primary-light)' : 'var(--primary)'
            }
            strokeWidth={1}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          ...
          <path
            ...
            name="Gandaki"
            fill={
              hoveredPath === 'NPGA' ? 'var(--primary-light)' : 'var(--primary)'
            }
            strokeWidth={1}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
          ...
          <path
            ...
            name="Bagmati"
            fill={
              hoveredPath === 'NPBA' ? 'var(--primary-light)' : 'var(--primary)'
            }
            strokeWidth={1}
            style={{ cursor: 'pointer', transition: 'fill 0.2s' }}
            ...
            {PIN_LOCATIONS.map((pin, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {pin.address.length > 32
                      ? pin.address.slice(0, 30) + '...'
                      : pin.address}
                  </text>
                </g>
              );
